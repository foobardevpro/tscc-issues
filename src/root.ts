...
3. Comment out the console log at the bottom of this file, and save -- now the watch does bundle, BUT, it bundles all modules into a single file! (names it bundle2.js)
